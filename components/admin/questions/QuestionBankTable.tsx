...
const QuestionBankTable: React.FC<QuestionBankTableProps> = ({ questions, onEdit, onDelete }) => {
            ...
            {questions.map((question, index) => (
              <tr key={question.id} className="hover:bg-[#F8FAFE] transition">
                ...
                <td className="px-4 py-3">
                  <span
                    className={`text-xs px-2 py-1 rounded-full font-medium capitalize ${getTypeBadgeColor(question.type)}`}>
                    {question.type}
                  </span>
                </td>
                ...
                <td className="px-4 py-3">
                  <span
                    className={`text-xs px-2 py-1 rounded-full font-medium capitalize ${getDifficultyColor(question.difficulty)}`}>
                    {question.difficulty}
                  </span>
                </td>
                <td className="px-4 py-3">
